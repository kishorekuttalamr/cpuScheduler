...
function calculateAverages(n, CT, TAT, WT, RT){
    ...
    document.getElementById("avg-comp-time-srtf").textContent = avgCT.toPrecision(3);
    document.getElementById("avg-turn-time-srtf").textContent = avgTAT.toPrecision(3);
    document.getElementById("avg-resp-time-srtf").textContent = avgRT.toPrecision(3);
    document.getElementById("avg-wt-time-srtf").textContent = avgWT.toPrecision(3);
