...
function display(n, WT, TAT, CT, RT, proNo){
    ...
    for(let i = 0; i < n; i++){
        ...
        table.rows[rowNo].cells[5].innerHTML = RT[i];1
...
function calculateAverages(n, CT, TAT,RT, WT){
    ...
    console.log(avgCT);
    document.getElementById("avg-comp-time-fcfs").textContent = avgCT.toPrecision(3);
    document.getElementById("avg-turn-time-fcfs").textContent = avgTAT.toPrecision(3);
    document.getElementById("avg-resp-time-fcfs").textContent = avgRT.toPrecision(3);
    document.getElementById("avg-wt-time-fcfs").textContent = avgWT.toPrecision(3);
...
//     document.getElementById("delRow").classList.add("d-none");
//     document.getElementById("execute").classList.add("d-none");
