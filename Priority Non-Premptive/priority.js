...
function calculateAverages(n, totCT, totTAT, totRT, totWT){
    ...
    document.getElementById("avg-comp-time-priority").textContent = avgCT.toPrecision(3);
    document.getElementById("avg-turn-time-priority").textContent = avgTAT.toPrecision(3);
    document.getElementById("avg-resp-time-priority").textContent = avgRT.toPrecision(3);
    document.getElementById("avg-wt-time-priority").textContent = avgWT.toPrecision(3);
}
