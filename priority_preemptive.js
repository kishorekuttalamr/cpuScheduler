...
function calculateAverages(n, totCT, totTAT, totRT, totWT){
    ...
    document.getElementById("avg-comp-time-priority-preemptive").textContent = avgCT.toPrecision(3);
    document.getElementById("avg-turn-time-priority-preemptive").textContent = avgTAT.toPrecision(3);
    document.getElementById("avg-resp-time-priority-preemptive").textContent = avgRT.toPrecision(3);
    document.getElementById("avg-wt-time-priority-preemptive").textContent = avgWT.toPrecision(3);
}
